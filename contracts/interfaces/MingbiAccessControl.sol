...
contract MingbiAccessControl {
    ...
    //         set to the address that created the smart contract in the MingbiCore constructor.
    //
    //     - The CFO: The CFO can withdraw funds from MingbiCore and its auction contracts.
    //
    ...
    ///  one reason we may pause the contract is when CFO accounts are
    ///  compromised.
